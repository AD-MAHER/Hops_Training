// **************************************CART BOX CODE ********************************************************
    function Submit() {
      ...
      for (var i = 1; i <= 3; i++) {
          ...
          if (A.checked == true) {
              document.getElementById("Rem" + i).innerHTML = document.getElementById("Rem" + i).innerHTML +"<input type='checkbox' value='" + Valued + "' id='Item" + i + "'> <label>" + document.getElementById("Item" + i).value + "</label><br>"
  ...
  function Remove() {
      for (var i = 1; i <= 3; i++) {
          ...
          var Valued = document.getElementById("Item" + i).value
          if (A.checked == true) {
              document.getElementById("Sel" + i).innerHTML = document.getElementById("Sel" + i).innerHTML +"<input type='checkbox' value='" + Valued + "' id='Item" + i + "'> <label>" + document.getElementById("Item" + i).value + "</label><br>"
    ...
    //     let k = 3
    //     document.getElementById("Sel" + (k+1) ).innerHTML = document.getElementById("Rem" + i).innerHTML +"<input type='checkbox' value='" + Valued + "' id='Item" + i + "'> <label>" + document.getElementById("Item" + i).value + "</label><br>"
  ...
  function clock (){
    var d = new Date();
     ...
     " <em class='text-danger clk'>"+hour+ "<small class='lead'>hours</small> :"+minute + "<small class='lead'>minutes</small> :"+seconds +"<small class='lead'>Seconds</small></em>"
 }
